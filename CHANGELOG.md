...
### Исправлено
- Исправлена конфигурация Dependabot: изменен `day: 1` на `day: "monday"` для корректной работы месячного расписания обновлений

## [1.0.6] - 2025-11-19

### Добавлено
- Добавлена интеграция Prettier в ESLint конфигурацию (eslint-plugin-prettier и eslint-config-prettier)
- Добавлен раздел "Структура пакета" в README.md для лучшего понимания организации кода

### Изменено
- Обновлены хуки pre-commit и pre-push: добавлена проверка статуса выхода команд с корректной обработкой ошибок
- Обновлен README.md: сокращен до самой важной информации по аналогии с kafka-client
- Обновлен llms.txt: сокращен для быстрого понимания сути пакета ИИ агентами
- Заменены команды pnpm на npm в README.md для унификации документации
